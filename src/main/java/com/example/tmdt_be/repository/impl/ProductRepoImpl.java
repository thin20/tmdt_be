...
public class ProductRepoImpl implements ProductRepoCustom {
    ...
    @Override
    public List<ProductSdo> searchListProductBySeller(Long userId, SearchProductBySellerSdi sdi) {
        Long categoryId = sdi.getCategoryId();
        String keyword = sdi.getKeyword();
        Pageable pageable = sdi.getPageable();
    ...
    @Override
    public Long countItemListProductBySeller(Long userId, SearchProductBySellerSdi sdi) {
        Long categoryId = sdi.getCategoryId();
        String keyword = sdi.getKeyword();
